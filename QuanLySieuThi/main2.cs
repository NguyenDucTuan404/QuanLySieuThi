...
namespace QuanLySieuThi
{
    public partial class main2 : Form
    {
        ...
        {
            String tt = "";
            tt += "Phần mềm : Quản lý Siêu thị ICTU  \n";
            ...
            tt += " Học phần : ";
            tt += "\t";
            tt += "Phần mềm phát triển hướng đối tượng";
            tt += "\n";
            tt += "\nSinh viên thực hiện : - Nhóm 7";
            tt += "\nversion : 1.1 @ năm 2024  \n\n";
            tt += "Email : phihung2003@gmail.com  \n\n";
            tt += "Facebook : https://www.facebook.com/nguyenphihung";
            tt += "\n";
